<section class="relative min-h-screen overflow-hidden font-inter">

        <section class="relative min-h-screen overflow-hidden">

            <!-- ================= BACKGROUND HERO IMAGE ================= -->
            <div class="absolute inset-0" data-aos="zoom-out" data-aos-duration="1200">
                <img src="/assets/images/hero-image.jpg" alt="Devobyte Hero" class="w-full h-full object-cover scale-[1.02]">
            </div>
            ...
            <!-- ================= FLOATING STATS CARD ================= -->
            <div class="absolute top-[45%] left-[12%]
                bg-white rounded-xl px-5 py-3 shadow-xl
                flex items-center gap-4 z-20 hidden lg:flex"
                data-aos="zoom-in" data-aos-delay="400">

                <div>
                    <p class="text-xs text-gray-500 font-inter">Monthly Traffic</p>
                    <p class="text-lg font-bold text-gray-900 font-inter">220,342.76</p>
                </div>

                <span class="text-xs bg-blue-500 text-white px-2 py-1 rounded-md font-semibold">
                    +3.4%
                </span>
            </div>
