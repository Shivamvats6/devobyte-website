...
<section class="relative min-h-[420px] flex items-center">
    ...
    <img src="/assets/images/Group 164726.png" class="absolute inset-0 w-full h-full object-cover" alt="Development Banner">
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative" data-aos="fade-right" data-aos-duration="900">
                <img src="/assets/images/web-custom.png"
                     alt="Devobyte Web App Development"
...
<section class="relative py-28 overflow-hidden"
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <!-- ================= MAIN CARD ================= -->
        <div class="relative bg-white rounded-3xl overflow-hidden shadow-2xl grid lg:grid-cols-2"
             data-aos="fade-up" data-aos-delay="100">

            <!-- ================= LEFT IMAGE PANEL ================= -->
            <div class="relative flex items-center justify-center p-10"
                 style="background: url('/assets/images/bluebg.png') center/cover no-repeat;"
                 data-aos="fade-right" data-aos-delay="200">

                <img src="/assets/images/webseo.png"
                     alt="Web App Challenges"
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-aos="fade-right">
                ...
                <p class="text-[#2F80FF] font-semibold mb-6">
                    Nam nec eros id magna hendrerit
                </p>
                ...
                <div class="absolute -top-6 -right-6 bg-white rounded-xl shadow-xl p-5 w-64
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center shrink-0">
                            <img src="/assets/images/statistics 1.svg"
                                 alt="Traffic Icon"
